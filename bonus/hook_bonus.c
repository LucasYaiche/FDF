...
/*   Updated: 2022/03/17 17:42:13 by lyaiche          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (keycode == 27)
		if (data->height > INT_MIN + 100)
			data->height -= 0.02;
	if (keycode == 13)
		if (data->rotate_y < INT_MAX - 1)
			data->rotate_y += 0.05;
	if (keycode == 1)
		if (data->rotate_y > INT_MIN + 1)
			data->rotate_y -= 0.05;
	if (keycode == 0)
		if (data->rotate_x < INT_MAX - 1)
			data->rotate_x += 0.05;
	if (keycode == 2)
		if (data->rotate_x > INT_MIN + 1)
			data->rotate_x -= 0.05;
	if (keycode == 14)
	{
		if (data->rotate_x < INT_MAX - 1
			&& data->rotate_y < INT_MAX - 1)
		{
			data->rotate_x += 0.05;
			data->rotate_y += 0.05;
		}
...
int	key_hook_bonus(int keycode, t_data *data)
{
	...
	if (keycode == 124)
		if (data->x_step < INT_MAX - 100)
			data->x_step += 15;
	if (keycode == 123)
		if (data->x_step > INT_MIN + 100)
			data->x_step -= 15;
	if (keycode == 125)
		if (data->y_step < INT_MAX - 100)
			data->y_step += 15;
	if (keycode == 126)
		if (data->y_step > INT_MIN + 100)
			data->y_step -= 15;
	if (keycode == 24)
		if (data->zoom < INT_MAX - 100)
			data->height += 0.02;
